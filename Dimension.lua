...
game:GetService("SoundService").RainSound:Destroy()
game:GetService("Players").LocalPlayer.PlayerGui.Player8Handler.QuakeSound:Destroy()
game:GetService("StarterGui").Player8Handler.QuakeSound:Destroy()
